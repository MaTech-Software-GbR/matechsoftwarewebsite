    ...
    <section className="s-works target-section" id="datenschutz">
      <div className="row">
        ...
        <p>
          ...
          Anbieter nicht nach dem EU-US-Data Privacy Framework (DPF)
        ...
        <p>
          ...
          Endger&auml;t oder zum Einsatz bestimmter Technologien einzuholen und
          diese datenschutzkonform zu dokumentieren. Anbieter dieser Technologie
          ist Cybot A/S, Havnegade 39, 1058 Kopenhagen, D&auml;nemark (im
          Folgenden &bdquo;Cookiebot&ldquo;).
        </p>
        <p>
          Wenn Sie unsere Website betreten, wird eine Verbindung zu den Servern
          von Cookiebot hergestellt, um Ihre Einwilligungen und sonstigen
          Erkl&auml;rungen zur Cookie-Nutzung einzuholen. Anschlie&szlig;end
          speichert Cookiebot einen Cookie in Ihrem Browser, um Ihnen die
          erteilten Einwilligungen bzw. deren Widerruf zuordnen zu k&ouml;nnen.
          Die so erfassten Daten werden gespeichert, bis Sie uns zur
          L&ouml;schung auffordern, den Cookiebot-Cookie selbst l&ouml;schen
        ...
        <p>
          ...
          Einwilligungen f&uuml;r den Einsatz von Cookies einzuholen.
        ...
        <p>
          ...
          LinkedIn wird dar&uuml;ber informiert, dass Sie diese Website mit
